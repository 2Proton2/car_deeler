  ...
  return (
    <>
        ...
        <div className='head-child-details pl-10 pt-5'>
          ...
          <h6 className='font-bold text-l text-red pt-1'>Rs. {data.newcardetails && data.newcardetails.price}*</h6>
      ...
      <div className='body pt-10 px-10 flex flex-row'>
        <div className='icon-section w-2/12 flex flex-col justify-between rounded-lg'>
          <div className='p-3  bg-lightBlue my-1 rounded-xl flex flex-row justify-between items-center'>
            ...
            <h6 className='font-medium pt-2 text-logoBlue text-sm'>{data.newcardetails && data.newcardetails.engine}</h6>
          </div>

          <div className='p-3  bg-lightBlue my-1 rounded-xl flex flex-row justify-between items-center'>
            <img src={powerIcon} style={{width:'50px', height: '50px'}}/>
            <h6 className='font-medium pt-2 text-logoBlue text-sm'>{data.newcardetails && data.newcardetails.power}</h6>
          </div>

          <div className='p-3  bg-lightBlue my-1 rounded-xl flex flex-row justify-between items-center'>
            <img src={transmissionIcon} style={{width:'50px', height: '50px'}}/>
            <h6 className='font-medium pt-2 text-logoBlue text-sm'>{data.newcardetails && data.newcardetails.transmission}</h6>
          </div>

          <div className='p-3  bg-lightBlue my-1 rounded-xl flex flex-row justify-between items-center'>
            <img src={speedometerIcon} style={{width:'50px', height: '50px'}}/>
            <h6 className='font-medium pt-2 text-logoBlue text-sm'>{data.newcardetails && data.newcardetails.mileage}</h6>
          </div>
        ...
        <div className='bg-lightBlue mx-4 rounded-xl p-5'>
          ...
          <h6 className='font-medium text-sm'>Transmission : {data.newcardetails && data.newcardetails.transmission}</h6>
