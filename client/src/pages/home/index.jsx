    ...
    <div className='home-page bg-customGray h-screen'>
      <div className='flex flex-row justify-between flex-wrap px-24 pt-48'>
        ...
        <div className='button-section w-1/4 px-10 bg-white flex flex-col items-center text-center'>
          ...
          <button className="inline-flex mb-2 w-3/4 text-white font-bold bg-logoBlue border-0 py-2 px-6 shadow shadow-logoBlue focus:outline-none hover:bg-indigo-600 rounded-lg text-2xl">
            New Car
          </button>
          <button className="inline-flex w-3/4 mb-6 text-white font-bold bg-red border-0 py-2 px-6 shadow shadow-red focus:outline-none hover:bg-indigo-600 rounded-lg text-2xl">
            Old Car
          </button>
        </div>
      </div>
